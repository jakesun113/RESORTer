...
class BookingActivity extends Component {
    ...
    goNext = pageName => {
        ...
        fetch(api_url, {method: "POST", body: JSON.stringify(upload_data)})
            ...
            .then(data => {
                if (data === "Success") {
                    let next_page_url = `/booking/${place}/` + pageName;
                    if (skip_state.every(skip => skip)) {
                        this.handleSkipRental(tripID, masterID);
                        //TODO: skip lesson (save tripID info into lesson table)
    ...
    async handleSkipRental(tripID, masterID) {
    ...
    render() {
        ...
        const finishedProcessList = ["step_1_in_book_page", "step_2_in_book_page"];
        ...
        return (
            <div className="container" style={{marginTop: "20px"}}>
                ...
                <div className="text-center" style={{marginTop: "30px"}}>
                    <MemberInfo style={{marginRight: "14vw"}}>
                        ...
                        >
              {members[currentMember].fullName}
            </span>
                    </MemberInfo>
              ...
              {members[currentMember].age}
                ...
                <div className="row">
                    ...
                    <div className="col-7">
                        ...
                        >
                            <strong>Not sure about your ability level?</strong>
                        </p>
                    </div>
                </div>
                ...
                <AArow className="row">
                    ...
                    <div className="col-7">
                        <SliderBar
                            value={members[currentMember]["ability"][0]}
                            min={1}
                            max={7}
                            id={"0"}
                ...
                <AArow className="row">
                    ...
                    <div className="col-7">
                        <SliderBar
                            value={members[currentMember]["ability"][1]}
                            min={1}
                            max={7}
                            id={"1"}
                            onChange={this.handleAbilityChange}
                ...
                <AArow className="row">
                    ...
                    <div className="col-7">
                        <SliderBar
                            value={members[currentMember]["ability"][2]}
                            min={1}
                            max={7}
                            id={"2"}
                            onChange={this.handleAbilityChange}
                ...
                <AArow className="row">
                    ...
                    <div className="col-7">
                        <SliderBar
                            value={members[currentMember]["ability"][3]}
                            min={1}
                            max={7}
                            id={"3"}
                            onChange={this.handleAbilityChange}
                ...
                <AArow className="row">
                    ...
                    <div className="col-7">
                        <SliderBar
                            value={members[currentMember]["ability"][4]}
                            min={1}
                            max={7}
                            id={"4"}
                            onChange={this.handleAbilityChange}
                ...
                <AArow className="row">
                    ...
                    <div className="col-7">
                        <SliderBar
                            value={members[currentMember]["ability"][5]}
                            min={1}
                            max={7}
                            id={"5"}
                            onChange={this.handleAbilityChange}
                ...
                <div className="row">
                    <div className="col-12"
                        ...
                        />
                        <label
                            style={{marginLeft: "20px", color: "#607375"}}
