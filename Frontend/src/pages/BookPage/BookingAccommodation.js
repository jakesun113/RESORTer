                ...
                <div className="col-12 col-md-10">
                    <form className="row">
                        <div className="col-5 col-md-3">
                            ...
                            />
                            <RadioLabel htmlFor={v1} className="radio-inline">
                                {v1}
                            </RadioLabel>
                        </div>
                        <div className="col-5 col-md-3">
                            <RadioInput
                                ...
                                onChange={this.handleChange}
                            />
                            <RadioLabel htmlFor={v2} className="radio-inline">
                                {v2}
                            </RadioLabel>
                        </div>
                        <div className="col-5 col-md-3">
                            <RadioInput
                                ...
                                onChange={this.handleChange}
                            />
                            <RadioLabel htmlFor={v3} className="radio-inline">
                                {v3}
                            </RadioLabel>
                        </div>
                        <div className="col-5 col-md-3">
                            <RadioInput
                                ...
                                onChange={this.handleChange}
                            />
                            <RadioLabel htmlFor={v4} className="radio-inline">
                                {v4}
                            </RadioLabel>
                        </div>
                    </form>
...
class BookingAccommodation extends Component {
    ...
    goNext = pageName => {
        ...
        if (
            ...
            fetch(api_url, {method: "POST", body: JSON.stringify(upload_data)})
                ...
                .then(data => {
                    if (data === "Upload Successfully.") {
                        const next_page_url = `/booking/${place}/` + pageName;
                        history.push({
    ...
    render() {
        ...
        const finishedProcessList = ["step_1_in_book_page"];
        ...
        return (
            <div className="container" style={{marginTop: "20px"}}>
                ...
                <p style={{marginBottom: "10px"}}>
                    Get a recommendation from the local folk at the resort
                </p>
                ...
                <NumberSelector
                    labelName="No. of Adults (18 yrs +):"
                    referName="num_adult"
                    cur_value={num_adult}
                    onChange={this.handleChange}
                />
                <NumberSelector
                    labelName="No. of Children (3-17 yrs):"
                    referName="num_child"
                    cur_value={num_child}
                    onChange={this.handleChange}
                />
                <NumberSelector
                    labelName="No. of Toddlers (0-2 yrs):"
                    referName="num_toddler"
                    cur_value={num_toddler}
                    onChange={this.handleChange}
                />
                ...
                <NumberSelector
                    labelName="Bedroom:"
                    referName="num_bedroom"
                    cur_value={num_bedroom}
                    onChange={this.handleChange}
                />
                <NumberSelector
                    labelName="Bathroom:"
                    referName="num_bathroom"
