    ...
    return (
      <div id="skiTripsMadeEasy" className="text-center container-fluid">
        ...
        <p className="plaintext">
          RESORTer is a quick, seamless booking enquiry experience to get ski
          trips quoted direct from any resort in the world - liftpasses,
          lessons, equipment hire, and accommodation - just one profile for all
          resorts and past trips can be cloned for even faster planning. Credit
          card payment is currently made direct with the resort but we're
