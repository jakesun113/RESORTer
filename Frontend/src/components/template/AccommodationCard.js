        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-10">
            <table className="table table-borderless">
              ...
              <tbody />
              {accommodation.map(eachAccommodation => (
                <tr
                  style={{
                    color: "#4682B3"
                  }}
                >
                  <td>{eachAccommodation.type}</td>
                  <td>{eachAccommodation.category}</td>
                  <td>{eachAccommodation.adultNum}</td>
                  <td>{eachAccommodation.childNum}</td>
                  <td>{eachAccommodation.todNum}</td>
                  <td>{eachAccommodation.bedNum}</td>
                  <td>{eachAccommodation.bathNum}</td>
                </tr>
              ))}
            </table>
          </div>
