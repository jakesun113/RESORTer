                  ...
                  <img
                      src="https://static.wixstatic.com/media/25b4a3_476f364fc74b4d3fb6c657519d3c90d2~mv2.png/v1/fill/w_366,h_156,al_c,usm_0.66_1.00_0.01/25b4a3_476f364fc74b4d3fb6c657519d3c90d2~mv2.png"/>
                        ...
                        <div className="row">
                            ...
                            {/* right */}
                            {this.props.login ? <div className="col-xs-12 col-lg-6">
                                <div>
                                ...
                                <div>
                                    <a className="nav-link" href="/" onClick={this.logout}>
                                        <SmallEllipseBtn text={this.props.user}/>
                                    </a>
                                </div>
                                <div>
                                    <a className="nav-link login_btn" href="/" onClick={this.logout}>
                                        <SmallEllipseBtn text="Log out"/>
                                    </a>
                                </div>
                            </div> : <div className="col-xs-12 col-lg-6">
                                <a className="nav-link login_btn" href="/login">
