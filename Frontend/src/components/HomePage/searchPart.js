    ...
    return (
      <div>
        <DropDown
          ...
          dropDownValue={this.handleCountryChange.bind(this)}
        />
      </div>
    );
  }
...
class LeftPass extends Component {
  ...
  render() {
    return (
      <DropDown
        defaultName="By LeftPass"
        options={this.state.leftPasses}
        dropDownValue={this.handleLeftPassChange.bind(this)}
      />
    );
  }
}
...
class ResortsFromCountry extends Component {
  ...
  render() {
    return (
      <DropDown
        defaultName="By Resorts"
        options={this.props.countryResorts}
        dropDownValue={this.handleResortChange.bind(this)}
      />
    );
  }
}
...
class ResortsFromLeftPass extends Component {
  ...
  render() {
    return (
      <DropDown
        defaultName="By LeftPass"
        options={this.props.leftPassResorts}
        dropDownValue={this.handleResortChange.bind(this)}
      />
    );
  }
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-sm">
              <Country
                setCountryChange={this.handleChangedCountry.bind(this)}
              />
            </div>
            <div className="col-sm">
              <ResortsFromCountry
                countryResorts={this.state.countryResorts}
                handleSelectedCountryResorts={this.handleSelectedCountryResorts.bind(
                  this
                )}
              />
            </div>
          ...
          <div className="row">
            <div className="col-sm">
              <LeftPass
                setLeftPassChange={this.handleChangedLeftPass.bind(this)}
              />
            </div>
            <div className="col-sm">
              <ResortsFromLeftPass
                leftPassResorts={this.state.leftPassResorts}
                handleSelectedLeftPassResorts={this.handleSelectedLeftPassResorts.bind(
                  this
                )}
              />
            </div>
