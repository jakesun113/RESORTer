        ...
        return (
            <React.Fragment>
                <div className='container' style={{marginTop: '20px', 'text-align': 'center'}}>
                    <img id="comp-jehyob76imgimage" alt="success"
                         ...
                         style={{width: '144px', height: '91px', 'object-fit': 'cover'}}/>
                    <h3 className="font_4">
                    ...
                    <span>​</span>
                    <div data-packed="false" data-min-height="18" className="txtNew" id="comp-jgpbcm9k">
               ...
               filling in this survey
                    ...
                    <Paragraph className="row justify-content-between ">
                        ...
                        <div className="col-4">
                            <a href="/">
                                <span
                                    style={{color: '#3D9BE9', 'text-decoration': 'underline'}}>Back to home page</span>
                            </a>
                        </div>
                    </Paragraph>
                </div>
