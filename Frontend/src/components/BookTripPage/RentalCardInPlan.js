...
class RentalCardInPlan extends Component {
    ...
    render() {
        return (
            ...
            (Change)
                    ...
                    <td style={{color: "#8CB50B"}}>{this.props.boots ? "Yes": "No"}</td>
                    <td style={{color: "#8CB50B"}}>{this.props.poles ? "Yes": "No"}</td>
...
export default RentalCardInPlan;
